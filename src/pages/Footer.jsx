...
const Footer = () => {
  return (
    <footer className="footer  mx-auto footer-center px-5 py-8 divide-y mt-20 bg-purple-900 text-primary-content">
    <div >
      ...
      <p className="font-bold">
        Tasty Hub .... <br/>Providing reliable chef since 1992
      </p> 
